                ...
                <div class="card-body">
                    <form method="POST" action="{{route('employee.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="details" type="text" class="form-control @error('details') is-invalid @enderror" name="details"></textarea>
                                @error('details')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="user_photo" type="file" class="form-control @error('user_photo') is-invalid @enderror" name="user_photo">
                                @error('user_photo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
